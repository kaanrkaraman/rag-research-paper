...
\item {\bf Declaration of LLM usage}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: LLM-based coding and writing assistants were used during preparation of this paper for prose drafting and revision, \LaTeX{} debugging, code generation and refinement (data-loading, evaluation harness, figure-generation scripts), and surfacing edge cases for human review. All substantive technical claims, experimental designs, statistical tests, and result interpretations were authored and independently verified by the human authors against the underlying per-query data; no LLM-generated text or analysis appears as a final claim without that verification. Per the checklist note, writing/editing-only LLM use does not strictly require declaration; we disclose it here for transparency.
